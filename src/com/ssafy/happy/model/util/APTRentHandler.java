...
public class APTRentHandler {

	private List<HouseDealDTO> houses = new ArrayList<>();
	private HouseDealDTO house;

	public APTRentHandler() {
		BufferedReader br = null;

		try {
			String str = "http://openapi.molit.go.kr/OpenAPI_ToolInstallPackage/service/rest/RTMSOBJSvc/getRTMSDataSvcAptRent?LAWD_CD=11110&DEAL_YMD=201512&serviceKey=ng%2B9adJCQm9rvqGUApsSL7DJT381Sa2GRmyTllx5%2F90Fqq5IXrU46RQIFm%2BMpo0bdzaI%2BJDJP58Hq1U3%2FV3Omg%3D%3D";
			URL url = new URL(str);
